  ...
  "cells": [
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "6ee6030d",
        "outputId": "3bbdda32-be7e-4439-9d79-17ce234adf31"
      },
      "outputs": [
        {
          ...
          "data": {
            ...
            "text/html": [
              "\n",
              "     <input type=\"file\" id=\"files-6ab29447-d390-4333-858c-eb60a3a34857\" name=\"files[]\" multiple disabled\n",
              "        style=\"border:none\" />\n",
              "     <output id=\"result-6ab29447-d390-4333-858c-eb60a3a34857\">\n",
        ...
        },
        {
          ...
          "data": {
            ...
            "text/html": [
              "\n",
              "  <div id=\"df-a040e210-e567-4099-aa9f-95c827615b28\" class=\"colab-df-container\">\n",
              "    <div>\n",
              "<style scoped>\n",
              ...
              "    <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-a040e210-e567-4099-aa9f-95c827615b28')\"\n",
              ...
              "    <script>\n",
              "      const buttonEl =\n",
              "        document.querySelector('#df-a040e210-e567-4099-aa9f-95c827615b28 button.colab-df-convert');\n",
              "      buttonEl.style.display =\n",
              "        google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "      async function convertToInteractive(key) {\n",
              "        const element = document.querySelector('#df-a040e210-e567-4099-aa9f-95c827615b28');\n",
              "        const dataTable =\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "d58b3bd0",
        "outputId": "919f4f51-aaf5-4274-c23c-e7ea60a3d86b"
      },
      "outputs": [
        {
          "output_type": "stream",
        ...
        },
        {
          ...
          "data": {
            "text/plain": [
              ...
              "0        71948.0               0                  RENT    35000.0    PERSONAL   \n",
              "1        12282.0               0                   OWN     1000.0   EDUCATION   \n",
              "2        12438.0               3              MORTGAGE     5500.0     MEDICAL   \n",
              "3        79753.0               0                  RENT    35000.0     MEDICAL   \n",
              "4        66135.0               1                  RENT    35000.0     MEDICAL   \n",
              "\n",
            ...
            "text/html": [
              "\n",
              "  <div id=\"df-873e2478-4fb8-4370-9dbb-7d564c56a7e2\" class=\"colab-df-container\">\n",
              "    <div>\n",
              "<style scoped>\n",
              "    .dataframe tbody tr th:only-of-type {\n",
              "        vertical-align: middle;\n",
              ...
              "\n",
              "  <div class=\"colab-df-container\">\n",
              "    <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-873e2478-4fb8-4370-9dbb-7d564c56a7e2')\"\n",
              "            title=\"Convert this dataframe to an interactive table.\"\n",
              "            style=\"display:none;\">\n",
              "\n",
              "  <svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\" viewBox=\"0 -960 960 960\">\n",
              ...
              "    <script>\n",
              "      const buttonEl =\n",
              "        document.querySelector('#df-873e2478-4fb8-4370-9dbb-7d564c56a7e2 button.colab-df-convert');\n",
              "      buttonEl.style.display =\n",
              "        google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "      async function convertToInteractive(key) {\n",
              "        const element = document.querySelector('#df-873e2478-4fb8-4370-9dbb-7d564c56a7e2');\n",
              "        const dataTable =\n",
              "          await google.colab.kernel.invokeFunction('convertToInteractive',\n",
              "                                                    [key], {});\n",
              "        if (!dataTable) return;\n",
            ...
            "application/vnd.google.colaboratory.intrinsic+json": {
              "type": "dataframe",
              "variable_name": "X",
              "summary": "{\n  \"name\": \"X\",\n  \"rows\": 45000,\n  \"fields\": [\n    {\n      \"column\": \"person_income\",\n      \"properties\": {\n        \"dtype\": \"number\",\n        \"std\": 80422.49863189556,\n        \"min\": 8000.0,\n        \"max\": 7200766.0,\n        \"num_unique_values\": 33989,\n        \"samples\": [\n          48967.0,\n          31001.0,\n          118444.0\n        ],\n        \"semantic_type\": \"\",\n        \"description\": \"\"\n      }\n    },\n    {\n      \"column\": \"person_emp_exp\",\n      \"properties\": {\n        \"dtype\": \"number\",\n        \"std\": 6,\n        \"min\": 0,\n        \"max\": 125,\n        \"num_unique_values\": 63,\n        \"samples\": [\n          93,\n          76,\n          0\n        ],\n        \"semantic_type\": \"\",\n        \"description\": \"\"\n      }\n    },\n    {\n      \"column\": \"person_home_ownership\",\n      \"properties\": {\n        \"dtype\": \"category\",\n        \"num_unique_values\": 4,\n        \"samples\": [\n          \"OWN\",\n          \"OTHER\",\n          \"RENT\"\n        ],\n        \"semantic_type\": \"\",\n        \"description\": \"\"\n      }\n    },\n    {\n      \"column\": \"loan_amnt\",\n      \"properties\": {\n        \"dtype\": \"number\",\n        \"std\": 6314.8866905411405,\n        \"min\": 500.0,\n        \"max\": 35000.0,\n        \"num_unique_values\": 4483,\n        \"samples\": [\n          5800.0,\n          28338.0,\n          1442.0\n        ],\n        \"semantic_type\": \"\",\n        \"description\": \"\"\n      }\n    },\n    {\n      \"column\": \"loan_intent\",\n      \"properties\": {\n        \"dtype\": \"category\",\n        \"num_unique_values\": 6,\n        \"samples\": [\n          \"PERSONAL\",\n          \"EDUCATION\",\n          \"DEBTCONSOLIDATION\"\n        ],\n        \"semantic_type\": \"\",\n        \"description\": \"\"\n      }\n    },\n    {\n      \"column\": \"cb_person_cred_hist_length\",\n      \"properties\": {\n        \"dtype\": \"number\",\n        \"std\": 3.8797018451620433,\n        \"min\": 2.0,\n        \"max\": 30.0,\n        \"num_unique_values\": 29,\n        \"samples\": [\n          24.0,\n          25.0,\n          12.0\n        ],\n        \"semantic_type\": \"\",\n        \"description\": \"\"\n      }\n    },\n    {\n      \"column\": \"credit_score\",\n      \"properties\": {\n        \"dtype\": \"number\",\n        \"std\": 50,\n        \"min\": 390,\n        \"max\": 850,\n        \"num_unique_values\": 340,\n        \"samples\": [\n          492,\n          484,\n          613\n        ],\n        \"semantic_type\": \"\",\n        \"description\": \"\"\n      }\n    },\n    {\n      \"column\": \"previous_loan_defaults_on_file\",\n      \"properties\": {\n        \"dtype\": \"category\",\n        \"num_unique_values\": 2,\n        \"samples\": [\n          \"Yes\",\n          \"No\"\n        ],\n        \"semantic_type\": \"\",\n        \"description\": \"\"\n      }\n    },\n    {\n      \"column\": \"loan_percent_income\",\n      \"properties\": {\n        \"dtype\": \"number\",\n        \"std\": 0.08716599175766145,\n        \"min\": 0.0006576120790186672,\n        \"max\": 0.6641859720721536,\n        \"num_unique_values\": 44466,\n        \"samples\": [\n          0.08163431906773441,\n          0.14896247635220466\n        ],\n        \"semantic_type\": \"\",\n        \"description\": \"\"\n      }\n    }\n  ]\n}"
            }
          },
          "metadata": {},
          "execution_count": 3
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "5c8696c0",
        "outputId": "821adcef-5c5f-4937-8274-0fc33e83031c"
      },
      "outputs": [
        {
          "output_type": "stream",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "4be34871",
        "outputId": "8bc6ff93-48e7-4899-f3fc-4e33989e647a"
      },
      "outputs": [
        {
          "output_type": "execute_result",
          "data": {
            ...
            "text/html": [
              "\n",
              "  <div id=\"df-629d6609-17bf-4f9b-b90a-e6ac57f6040a\" class=\"colab-df-container\">\n",
              "    <div>\n",
              "<style scoped>\n",
              "    .dataframe tbody tr th:only-of-type {\n",
              "        vertical-align: middle;\n",
              ...
              "\n",
              "  <div class=\"colab-df-container\">\n",
              "    <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-629d6609-17bf-4f9b-b90a-e6ac57f6040a')\"\n",
              "            title=\"Convert this dataframe to an interactive table.\"\n",
              "            style=\"display:none;\">\n",
              "\n",
              "  <svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\" viewBox=\"0 -960 960 960\">\n",
              ...
              "    <script>\n",
              "      const buttonEl =\n",
              "        document.querySelector('#df-629d6609-17bf-4f9b-b90a-e6ac57f6040a button.colab-df-convert');\n",
              "      buttonEl.style.display =\n",
              "        google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "      async function convertToInteractive(key) {\n",
              "        const element = document.querySelector('#df-629d6609-17bf-4f9b-b90a-e6ac57f6040a');\n",
              "        const dataTable =\n",
              "          await google.colab.kernel.invokeFunction('convertToInteractive',\n",
              "                                                    [key], {});\n",
              "        if (!dataTable) return;\n",
              ...
              "\n",
              "\n",
              "  <div id=\"id_e766d5cb-9da6-4558-b4f9-7434936b8d10\">\n",
              "    <style>\n",
              "      .colab-df-generate {\n",
              "        background-color: #E8F0FE;\n",
              "        border: none;\n",
              ...
              "      }\n",
              "    </style>\n",
              "    <button class=\"colab-df-generate\" onclick=\"generateWithVariable('results_ml')\"\n",
              ...
              "      (() => {\n",
              "      const buttonEl =\n",
              "        document.querySelector('#id_e766d5cb-9da6-4558-b4f9-7434936b8d10 button.colab-df-generate');\n",
              "      buttonEl.style.display =\n",
              "        google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "      buttonEl.onclick = () => {\n",
              "        google.colab.notebook.generateWithVariable('results_ml');\n",
              "      }\n",
              "      })();\n",
              "    </script>\n",
              "  </div>\n",
            ...
            "application/vnd.google.colaboratory.intrinsic+json": {
              "type": "dataframe",
              "variable_name": "results_ml",
              "summary": "{\n  \"name\": \"results_ml\",\n  \"rows\": 5,\n  \"fields\": [\n    {\n      \"column\": \"Accuracy\",\n      \"properties\": {\n        \"dtype\": \"number\",\n        \"std\": 0.013511461983748163,\n        \"min\": 0.8698666666666667,\n        \"max\": 0.904,\n        \"num_unique_values\": 5,\n        \"samples\": [\n          0.8959111111111111,\n          0.8698666666666667,\n          0.8787555555555555\n        ],\n        \"semantic_type\": \"\",\n        \"description\": \"\"\n      }\n    },\n    {\n      \"column\": \"Precision\",\n      \"properties\": {\n        \"dtype\": \"number\",\n        \"std\": 0.055973250796007665,\n        \"min\": 0.7358834244080146,\n        \"max\": 0.8782014797951053,\n        \"num_unique_values\": 5,\n        \"samples\": [\n          0.8782014797951053,\n          0.7358834244080146,\n          0.784\n        ],\n        \"semantic_type\": \"\",\n        \"description\": \"\"\n      }\n    },\n    {\n      \"column\": \"Recall\",\n      \"properties\": {\n        \"dtype\": \"number\",\n        \"std\": 0.027607824977712404,\n        \"min\": 0.6172,\n        \"max\": 0.6884,\n        \"num_unique_values\": 5,\n        \"samples\": [\n          0.6172,\n          0.6464,\n          0.6272\n        ],\n        \"semantic_type\": \"\",\n        \"description\": \"\"\n      }\n    },\n    {\n      \"column\": \"F1\",\n      \"properties\": {\n        \"dtype\": \"number\",\n        \"std\": 0.028486899413799685,\n        \"min\": 0.6882453151618398,\n        \"max\": 0.7611676249447147,\n        \"num_unique_values\": 5,\n        \"samples\": [\n          0.7249236551562133,\n          0.6882453151618398,\n          0.6968888888888889\n        ],\n        \"semantic_type\": \"\",\n        \"description\": \"\"\n      }\n    },\n    {\n      \"column\": \"AUC\",\n      \"properties\": {\n        \"dtype\": \"number\",\n        \"std\": 0.010766500743350237,\n        \"min\": 0.9353163885714286,\n        \"max\": 0.9607488685714286,\n        \"num_unique_values\": 5,\n        \"samples\": [\n          0.9534461257142856,\n          0.9353163885714286,\n          0.9410401371428571\n        ],\n        \"semantic_type\": \"\",\n        \"description\": \"\"\n      }\n    },\n    {\n      \"column\": \"Model\",\n      \"properties\": {\n        \"dtype\": \"string\",\n        \"num_unique_values\": 5,\n        \"samples\": [\n          \"Random Forest\",\n          \"Logistic Regression\",\n          \"Extra Trees\"\n        ],\n        \"semantic_type\": \"\",\n        \"description\": \"\"\n      }\n    }\n  ]\n}"
            }
          },
          "metadata": {},
          "execution_count": 6
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "b52e705a",
        "outputId": "eb280cbd-5183-4142-e9c6-791acb169039"
      },
      "outputs": [
        {
          "output_type": "stream",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "31def60d",
        "outputId": "701a49ef-9cc0-4f1d-d08d-50c13b79adb4"
      },
      "outputs": [
        {
          "output_type": "execute_result",
          "data": {
            ...
            "text/html": [
              "\n",
              "  <div id=\"df-fdc3100e-8074-431e-bbc1-c246f057bf4b\" class=\"colab-df-container\">\n",
              "    <div>\n",
              "<style scoped>\n",
              "    .dataframe tbody tr th:only-of-type {\n",
              "        vertical-align: middle;\n",
              ...
              "\n",
              "  <div class=\"colab-df-container\">\n",
              "    <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-fdc3100e-8074-431e-bbc1-c246f057bf4b')\"\n",
              "            title=\"Convert this dataframe to an interactive table.\"\n",
              "            style=\"display:none;\">\n",
              "\n",
              "  <svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\" viewBox=\"0 -960 960 960\">\n",
              ...
              "    <script>\n",
              "      const buttonEl =\n",
              "        document.querySelector('#df-fdc3100e-8074-431e-bbc1-c246f057bf4b button.colab-df-convert');\n",
              "      buttonEl.style.display =\n",
              "        google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "      async function convertToInteractive(key) {\n",
              "        const element = document.querySelector('#df-fdc3100e-8074-431e-bbc1-c246f057bf4b');\n",
              "        const dataTable =\n",
              "          await google.colab.kernel.invokeFunction('convertToInteractive',\n",
              "                                                    [key], {});\n",
              "        if (!dataTable) return;\n",
              ...
              "\n",
              "\n",
              "  <div id=\"id_13f9eecf-6beb-41b5-98ba-a301a7ed1d47\">\n",
              "    <style>\n",
              "      .colab-df-generate {\n",
              "        background-color: #E8F0FE;\n",
              "        border: none;\n",
              ...
              "      (() => {\n",
              "      const buttonEl =\n",
              "        document.querySelector('#id_13f9eecf-6beb-41b5-98ba-a301a7ed1d47 button.colab-df-generate');\n",
              "      buttonEl.style.display =\n",
              "        google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "      buttonEl.onclick = () => {\n",
            ...
            "application/vnd.google.colaboratory.intrinsic+json": {
              ...
              "summary": "{\n  \"name\": \"all_results\",\n  \"rows\": 6,\n  \"fields\": [\n    {\n      \"column\": \"Accuracy\",\n      \"properties\": {\n        \"dtype\": \"number\",\n        \"std\": 0.012175376892282883,\n        \"min\": 0.8698666666666667,\n        \"max\": 0.904,\n        \"num_unique_values\": 6,\n        \"samples\": [\n          0.904,\n          0.8959111111111111,\n          0.8698666666666667\n        ],\n        \"semantic_type\": \"\",\n        \"description\": \"\"\n      }\n    },\n    {\n      \"column\": \"Precision\",\n      \"properties\": {\n        \"dtype\": \"number\",\n        \"std\": 0.050362979779334315,\n        \"min\": 0.7358834244080146,\n        \"max\": 0.8782014797951053,\n        \"num_unique_values\": 6,\n        \"samples\": [\n          0.8511374876360039,\n          0.8782014797951053,\n          0.7358834244080146\n        ],\n        \"semantic_type\": \"\",\n        \"description\": \"\"\n      }\n    },\n    {\n      \"column\": \"Recall\",\n      \"properties\": {\n        \"dtype\": \"number\",\n        \"std\": 0.02491254034952412,\n        \"min\": 0.6172,\n        \"max\": 0.6884,\n        \"num_unique_values\": 6,\n        \"samples\": [\n          0.6884,\n          0.6172,\n          0.6464\n        ],\n        \"semantic_type\": \"\",\n        \"description\": \"\"\n      }\n    },\n    {\n      \"column\": \"F1\",\n      \"properties\": {\n        \"dtype\": \"number\",\n        \"std\": 0.025764679515300197,\n        \"min\": 0.6882453151618398,\n        \"max\": 0.7611676249447147,\n        \"num_unique_values\": 6,\n        \"samples\": [\n          0.7611676249447147,\n          0.7249236551562133,\n          0.6882453151618398\n        ],\n        \"semantic_type\": \"\",\n        \"description\": \"\"\n      }\n    },\n    {\n      \"column\": \"AUC\",\n      \"properties\": {\n        \"dtype\": \"number\",\n        \"std\": 0.009660317512090975,\n        \"min\": 0.9353163885714286,\n        \"max\": 0.9607488685714286,\n        \"num_unique_values\": 6,\n        \"samples\": [\n          0.9607488685714286,\n          0.9534461257142856,\n          0.9353163885714286\n        ],\n        \"semantic_type\": \"\",\n        \"description\": \"\"\n      }\n    },\n    {\n      \"column\": \"Model\",\n      \"properties\": {\n        \"dtype\": \"string\",\n        \"num_unique_values\": 6,\n        \"samples\": [\n          \"HistGradientBoosting\",\n          \"Random Forest\",\n          \"Logistic Regression\"\n        ],\n        \"semantic_type\": \"\",\n        \"description\": \"\"\n      }\n    }\n  ]\n}"
            }
          },
          "metadata": {},
          "execution_count": 8
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "5e045daf",
        "outputId": "35282eb0-8544-4fa4-ff38-15bffe922367"
      },
      "outputs": [
        {
          "output_type": "stream",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "5ff1bc23",
        "outputId": "cc8ef5b8-6fa5-4e57-edab-ec93b074bc3b"
      },
      "outputs": [
        {
          "output_type": "stream",
        ...
        },
        {
          ...
          "data": {
            ...
            "text/html": [
              "<div><iframe src=\"https://674f66ce2c7d4d1bb2.gradio.live\" width=\"100%\" height=\"500\" allow=\"autoplay; camera; microphone; clipboard-read; clipboard-write;\" frameborder=\"0\" allowfullscreen></iframe></div>"
            ]
          },
          "metadata": {}
        },
